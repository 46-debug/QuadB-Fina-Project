...
const Steps = () => {
    return (
        <div className={`flex flex-col sm:flex-row relative overflow-hidden sm:justify-between justify-center sm:pl-10 pl-3 items-center`}>
            <img className='absolute sm:top-[80%] top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]' src={blur} alt="" />
            <div>
                ...
                <Link to="/features">
                    <button className='px-7 text-white mt-10 py-3 rounded-[10px] border-[1px] border-[solid] border-[rgba(39,55,207,0.40)] bg-[linear-gradient(180deg,_rgba(0,_0,_0,_0.00)_-40.91%,_#402788_132.95%)] [box-shadow:0px_10px_40px_0px_rgba(63,_74,_175,_0.50),_0px_10px_30px_0px_rgba(73,_123,_255,_0.70)_inset] backdrop-filter backdrop-blur-[10px] inline-flex justify-center items-center gap-3'>
                        START FREE TRIAL
                        <img src={aero} alt="" />
                    </button>
                </Link>
