...
const Features = () => {
    return (
        <div className='bg-black justify-center relative flex gap-2 flex-col sm:w-[750px] h-screen'>
            ...
            <div id='heading2' className="self-stretch text-white/80 text-center text-2xl font-normal font-inter">3 hours of video</div>
            <h2 id='heading3' className="self-stretch text-white/80 text-center justify-start sm:text-5xl text-4xl font-medium font-['Inter']">Quick and beautiful web design: Streamlining your creative process</h2>
